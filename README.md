...
一个基于HTML/CSS/JavaScript的实时打字追逐游戏，灵感来源于金山打字通生死时速模式。通过实时打字速度来控制角色移动，实现类似生死时速的追逐体验。

## 游戏介绍

这是一个创新的实时打字练习游戏，将传统的打字练习与高速追逐游戏相结合。玩家可以选择扮演逃跑者或追逐者，通过实时打字速度来控制角色移动，体验紧张刺激的追逐乐趣。
...
- 🚗 **实时移动系统**：类似生死时速的实时打字控制移动
- 🎨 **2D Canvas渲染**：全新的2D俯视角游戏画面
- 🎯 **智能AI系统**：根据难度调整AI行为模式
- ⚡ **错误惩罚机制**：准确率影响移动速度，而非完全停止
- 🗺️ **地图系统**：支持多种地图环境和视觉风格
- 🎮 **游戏状态管理**：完整的游戏开始、进行、结束流程
